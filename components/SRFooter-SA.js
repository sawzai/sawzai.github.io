                ...
                <div class="col-md-4">
                    ...
                    <ul>
                        <li class="text-light">
                            ...
                            <a target="_blank" class="text-light" href="tel:+27107450583">+27 10 745 0583</a>
                        </li>
                        <li class="text-light">
                            <i class="fa fa-whatsapp" aria-hidden="true"></i>
                            <a target="_blank" class="text-light" href="https://wa.me/27724208467">+27 72 420 8467</a>
                        </li>
                        <li class="text-light">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                            <a target="_blank" class="text-light" href="mailto:info.za@srglobal.com">info.za@srglobal.com</a>
                        </li>
                    </ul>
                    <p>
