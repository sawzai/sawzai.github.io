...
const srCart = {
	...
	checkParams: function () {
		const affiliateParam = this.getParams('am_id');
...
document.addEventListener("DOMContentLoaded", function () {
	srCart.trackData['am_id'] = 'website'
    srCart.trackData['utm_source'] = 'website'
	srCart.btnClass = '.parameter-cart'
	srCart.init();
});
