                ...
                <div class="col-md-4">
                    ...
                    <ul>
                        ...
                        <li class="text-light">
                            ...
                            <a target="_blank" class="text-light" href="mailto:https://wa.me/447458159416">+44 745 815 9416</a>
                        </li>
                        <li class="text-light">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                            <a target="_blank" class="text-light" href="info.uk@srglobal.com">info.uk@srglobal.com</a>
                        </li>
                    </ul>
                </div>
            </div>
