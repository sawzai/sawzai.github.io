            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="py-3 d-flex gap-3">
                        ...
                        <a class="text-light h2 footer-icon" href="https://successresources.com/" target="_blank" rel="noopener noreferrer">
                ...
                <div class="col-md-4">
                    ...
                    <ul>
                        <li class="text-light">
                            ...
                            <a target="_blank" rel="noopener noreferrer" class="text-light" href="tel:+27107450583">+27 10 745 0583</a>
                        </li>
                        <li class="text-light">
                            <i class="fa fa-whatsapp" aria-hidden="true"></i>
                            <a target="_blank" rel="noopener noreferrer" class="text-light" href="https://wa.me/27724208467">+27 72 420 8467</a>
                        </li>
                        <li class="text-light">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                            <a target="_blank" rel="noopener noreferrer" class="text-light" href="mailto:info.za@srglobal.com">info.za@srglobal.com</a>
                        </li>
                    </ul>
                    <p>
